...
def main():
    ...
    if Lesson == 'Lesson1':
        ...
        Lesson3_texts = ['Do you have any comic books','Yes,I have a lot of them',
                         'Do you know the story of Cinderella','Do you have a pet?','Yes,I do',
                         'No,I do not','Do you want some tea?','I like chocolate ice cream',
                         'library','write','know','chair','math','science','start','study',
                         'notebook','homework','dictionary','favorite','magazine','a lot of',
                         'name','school','English','Of course','Me,too','Yes,please']
